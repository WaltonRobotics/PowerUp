...
public class OI {
    ...
    public static XboxController mainDriverController = new XboxController(XBOX_CONTROLLER_PORT);
    ...
    public static final JoystickButton quickTurnButton = new JoystickButton(rightJoystick, QUICK_TURN_PORT);
