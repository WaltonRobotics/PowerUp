...
import static frc.team2974.robot.Config.Path.CROSS_BASELINE_Y;
import static frc.team2974.robot.Robot.confuseEnemy;
import static frc.team2974.robot.Robot.drivetrain;
import static frc.team2974.robot.command.auton.GamePosition.CROSS_BASELINE_CENTER;
import static frc.team2974.robot.command.auton.GamePosition.CROSS_BASELINE_LEFT;
import static frc.team2974.robot.command.auton.GamePosition.CROSS_BASELINE_RIGHT;
import static frc.team2974.robot.command.auton.GamePosition.DRIVE_STATION_CENTER_SWITCH_LEFT;
import static frc.team2974.robot.command.auton.GamePosition.DRIVE_STATION_CENTER_SWITCH_RIGHT;
import static frc.team2974.robot.command.auton.GamePosition.DRIVE_STATION_LEFT_SWITCH_LEFT;
import static frc.team2974.robot.command.auton.GamePosition.DRIVE_STATION_RIGHT_SWITCH_RIGHT;

import edu.wpi.first.wpilibj.command.CommandGroup;
import frc.team2974.robot.Robot;
import frc.team2974.robot.command.auton.CrossBaseline;
import frc.team2974.robot.command.auton.DoNothingCommand;
import frc.team2974.robot.command.auton.DriveToScale;
import frc.team2974.robot.command.auton.DriveToSwitch;
import frc.team2974.robot.command.auton.GamePosition;
